...
| 5. [RunLengthEncoding](https://leetcode.com/problems/string-compression/) | [2 pointers: r - find similiar items, l - update ](5.RunLengthEncoding.md)  | M |
...
| 11. [Missing Numbers](https://practice.geeksforgeeks.org/problems/find-missing-and-repeating2512/1/) | [use indices as a measure (-1* if found ) ](11.MissingNumbers.md) | M |
